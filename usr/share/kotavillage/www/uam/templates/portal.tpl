...
<div id="container">
    ...
    {if $js}
        <script type="text/javascript" src="/kotavillage/uam/js/chilliMD5.js"></script>
        <script type="text/javascript" id='chillijs' src='/kotavillage/uam/js.php?js=jqchilli.js'></script>
