...
function tos_getresponse() {
    ...
    /* Build automac URL */
    var tosUrl = 'http://' + window.location.hostname + '/kotavillage/uam/automac?challenge=' + encodeURIComponent(challenge);
...
$('#statuslink').click(function () {
    var loginwindow = window.open('/kotavillage/uam/mini', 'kotavillage_uam', 'width=300,height=400,status=yes,resizable=yes');
    if (loginwindow) {
