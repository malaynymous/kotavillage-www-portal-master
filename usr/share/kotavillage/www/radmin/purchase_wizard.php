...
session_name('KotaVillagePurchaseWizard');
session_start();

$voucherWizard = new \KotaVillage\VoucherWizard($Settings, $templateEngine, DatabaseFunctions::getInstance(), new \Grase\VoucherWizard\State());
