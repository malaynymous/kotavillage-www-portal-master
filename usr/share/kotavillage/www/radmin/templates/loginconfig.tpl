...
<script src="/kotavillage/vendor/codemirror/lib/codemirror.js"></script>
<script src="/kotavillage/vendor/codemirror/addon/search/searchcursor.js" type="text/javascript"></script>
<link rel="stylesheet" href="/grase/vendor/codemirror/lib/codemirror.css">
<script src="/kotavillage/vendor/codemirror/mode/css/css.js"></script>
<script src="/kotavillage/vendor/codemirror/mode/xml/xml.js"></script>

<script src="/kotavillage/vendor/codemirror-ui/js/codemirror-ui.js" type="text/javascript"></script>
<link rel="stylesheet" href="/kotavillage/vendor/codemirror-ui/css/codemirror-ui.css" type="text/css" media="screen" />
    ...
    <div>
        ...
        <textarea name="{$option}" id="{$option}">{$attributes.value}</textarea>
            ...
            <script>
                ...
                {literal}
                var uiOptions = { path : '/kotavillage/vendor/codemirror-ui/js/', searchMode : 'popup', imagePath: '/javascript/codemirror-ui/images/silk', }
