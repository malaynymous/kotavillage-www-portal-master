...
<form method="post" action="?" class="generalForm" enctype="multipart/form-data">
    ...
    <div>
        ...
        <img src="/kotavillage/images/logo.png" alt="Logo"/>                
    </div>
...
{t}For more advanced logos, (different file type, size, placement}, manually upload the file to /var/www/ or /usr/share/kotavillage/www/images/ and use the custom CSS to override this logo. The logo is defined in the #page container as the background.{/t}
{literal}
<pre>
#page {
