...
<div>
    <button type="submit" name="changepasswordsubmit" value="{t}Change Password{/t}"><img src="/kotavillage/images/icons/textfield_key.png" alt=""/>{t}Change Password{/t}</button>
    <span>&nbsp;</span>
</div>
</form> 
</div>
...
<div>
    <button type="submit" name="addadminusersubmit" class="positive" value="Add new Admin User"><img src="/kotavillage/images/icons/tick.png" alt=""/>{t}Create new Admin User{/t}</button>
    <span>&nbsp;</span>
</div>
