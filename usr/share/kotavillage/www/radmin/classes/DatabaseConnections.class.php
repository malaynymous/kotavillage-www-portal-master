...
class DatabaseConnections
{
    ...
    public function &getInstance($radiusDatabaseSettingsFile = '/etc/kotavillage/radius.conf', $radminDatabaseSettingsFile = '/etc/kotavillage/radmin.conf')
    {
    ...
    public function __construct($radiusDatabaseSettingsFile = '/etc/kotavillage/radius.conf', $radminDatabaseSettingsFile = '/etc/kotavillage/radmin.conf')
    {
    ...
    private function loadSettingsFromFile($dbSettingsFile)
    {
        ...
        if (!is_readable($dbSettingsFile)) {
            \KotaVillage\ErrorHandling::fatalNoDatabaseError(
    ...
    private function connectDatabase()
    {
        ...
        if (PEAR::isError($this->radminDB)) {
            ...
            $this->radminDB =& MDB2::connect($this->radminDSN, $this->radminOptions);
            if (PEAR::isError($this->radminDB)) {
                \KotaVillage\ErrorHandling::fatalNoDatabaseError($this->radminDB->getMessage() . " RADMIN");
            }
        }
