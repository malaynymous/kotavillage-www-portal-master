...
if (isset($_POST['submit'])) {
    $newLocationName = \KotaVillage\Clean::text($_POST['locationname']);
    $newSupportContact = \KotaVillage\Clean::text($_POST['supportcontact']);
    $newSupportLink = \KotaVillage\Clean::text($_POST['supportlink']);
    ...
    $newLocale = \KotaVillage\Clean::text($_POST['locale']);
    $newWebsiteName = \KotaVillage\Clean::text($_POST['websitename']);
    $newWebsiteLink = \KotaVillage\Clean::text($_POST['websitelink']);
...
function updateLocaleSetting($locale)
{
    ...
    if (isset($newLocale['language'])) {
        ...
        if ($Settings->setSetting('locale', $locale)) {
            ...
            \KotaVillage\Locale::applyLocale($locale);
